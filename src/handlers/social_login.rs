...
// use crate::models::models::{AppState, NewUser, NewWallet, RegisterResponse};
// use reqwest::Client;
...
//         .transaction(|conn| {
//
//             let existing_user: Option<Uuid> = crate::schema::users::table
...
//             } else {
//                 // Create new user
//                 let user_id: Uuid = diesel::insert_into(crate::schema::users::table)
//                     .values(NewUser {
