...
pub use models::models::AppState;
...
use crate::handlers::initialize_banks::initialize_banks;
...
pub async fn run() -> Result<(), eyre::Error> {
    ...
    let state = Arc::new(AppState {
        db: pool,
        jwt_secret: SecretString::new(crate::config::security_config::JWTSecret::new().jwt_secret.into()),
    ...
    let app = crate::app::create_router(state.clone()).layer(cors);
